package com.example.krid.util;

public class Constants {
    public static final int ACTIVITY_GUEST = 100;
    public static final int ACTIVITY_INFLUENCE = 200;
    public static final int ACTIVITY_ADVERTISER = 300;
